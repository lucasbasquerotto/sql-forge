                        ...
                        let _ = {
                            #[allow(clippy::all)]
                            {
                                ...
                                ::sqlx::__query_with_result::<
                                    ...
                                    _,
                                >(
                                    "\n        INSERT INTO products (name, price, stock, category)\n        VALUES (?, ?, 10, 'Batch'), (?, ?, 10, 'Batch'), (?, ?, 10, 'Batch')\n        ",
                                    query_args,
                                )
                            }
                        };
                        ...
                        let _ = {
                            #[allow(clippy::all)]
                            {
                                ...
                                ::sqlx::__query_with_result::<
                                    ...
                                    _,
                                >(
                                    "\n        INSERT INTO products (name, price, stock, category)\n        VALUES (?, ?, 10, 'BatchWithParams'), (?, ?, 10, 'BatchWithParams'), (?, ?, 10, 'BatchWithParams'), (?, ?, 10, 'BatchWithParams')\n        ",
                                    query_args,
                                )
                            }
                        };
                                ...
                                #[allow(clippy::all)]
                                {
                                    ...
                                    >(
                                        ...
                                        .try_map(|row: sqlx::mysql::MySqlRow| {
                                            ...
                                            #[allow(non_snake_case)]
                                            let sqlx_query_as_stock = row
                                                .try_get_unchecked::<i32, _>(2usize)?
                                                .into();
                                            #[allow(non_snake_case)]
                                            let sqlx_query_as_category = row
...
extern crate test;
#[rustc_test_marker = "execute_only_with_explicit_mysql_db"]
#[doc(hidden)]
pub const execute_only_with_explicit_mysql_db: test::TestDescAndFn = test::TestDescAndFn {
    desc: test::TestDesc {
        name: test::StaticTestName("execute_only_with_explicit_mysql_db"),
        ignore: false,
        ignore_message: ::core::option::Option::None,
        source_file: "tests/tests.rs",
        start_line: 972usize,
    ...
    testfn: test::StaticTestFn(
        #[coverage(off)]
        || test::assert_test_result(execute_only_with_explicit_mysql_db()),
    ),
};
fn execute_only_with_explicit_mysql_db() {
    let body = async {
        let pool = pool().await;
        {
            let _sql_forge_validator = || {
...
pub fn main() -> () {
    ...
    test::test_main_static(
        &[
            ...
            &execute_only_query,
            &execute_only_with_explicit_mysql_db,
            &grouped_sections,
